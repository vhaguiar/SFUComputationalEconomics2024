...
# Computes the atention index eta(D) for all D given the matrix of frequencies ps
...
# This function computes the elements of the summation in the defintion of
# the atention index eta
...
#This function computes all preference orders
